...
public:
  // constructing
  TGUI_BOX(TGUI_BOX *bowner, intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight);
...
public:
  // constructing
  TGUI_LABEL(TGUI_BOX *bowner, intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight);
  TGUI_LABEL(TGUI_BOX *bowner, intptr_t bkey, GLfloat bx, GLfloat by, const char *bcaption);
  TGUI_LABEL(TGUI_BOX *bowner, intptr_t bkey, GLfloat bx, GLfloat by, TGUI_TEXTURE *tex);
  virtual ~TGUI_LABEL() {
...
public:
  ...
  TGUI_LIST(TGUI_BOX *bowner, intptr_t bkey, GLfloat bx, GLfloat by, char *bitems)
...
public:
  // constructing
  TGUI_BUTTON(TGUI_BOX *bowner, intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight, const char *bcaption, int bstyle, int bgroup);
  TGUI_BUTTON(TGUI_BOX *bowner, intptr_t bkey, GLfloat bx, GLfloat by, TGUI_TEXTURE *tex, int bstyle, int bgroup);
...
public:
  // constructing
  TGUI_CHECK_BOX(TGUI_BOX *bowner, intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight, const char *bcaption, int bstyle, int bgroup)
    :TGUI_BUTTON(bowner, bkey, bx, by, bwidth, bheight, bcaption, bstyle, bgroup) {};
  TGUI_CHECK_BOX(TGUI_BOX *bowner, intptr_t bkey, GLfloat bx, GLfloat by, TGUI_TEXTURE *tex, int bstyle, int bgroup)
...
public:
  TGUI_EDIT_BOX(TGUI_BOX *bowner, intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight, unsigned max_lenght);
...
public:
  // constructing
  TGUI_SLIDER(TGUI_BOX *bowner, intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight, TGUI_SLIDER_TYPE btype);
...
public:
  // constructing
  TGUI_PANEL(TGUI_BOX *bowner, intptr_t pkey, GLfloat px, GLfloat py, GLfloat pwidth, GLfloat pheight)
    :TGUI_BOX(bowner, pkey, px, py, pwidth, pheight)
  { animation = NULL; child_list = last_child = NULL; padding = 5.0f; on_show = NULL; };


  TGUI_PANEL(TGUI_BOX *bowner, intptr_t pkey, GLfloat px, GLfloat py, TGUI_TEXTURE *tex)
  ...
  TGUI_PANEL      *AddPanel(intptr_t pkey, GLfloat px, GLfloat py, TGUI_TEXTURE *tex);
  TGUI_PANEL      *AddPanel(intptr_t pkey, GLfloat px, GLfloat py, GLfloat pwidth, GLfloat pheight, TGUI_TEXTURE *tex);

  TGUI_BUTTON     *AddButton(intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight, const char *bcaption);
  TGUI_BUTTON     *AddButton(intptr_t bkey, GLfloat bx, GLfloat by, TGUI_TEXTURE *tex);

  TGUI_BUTTON     *AddCheckButton(intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight, const char *bcaption);

  TGUI_BUTTON     *AddGroupButton(intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight, const char *bcaption, int bgroup);
  TGUI_BUTTON     *AddGroupButton(intptr_t bkey, GLfloat bx, GLfloat by, TGUI_TEXTURE *tex, int bgroup);

  TGUI_CHECK_BOX  *AddCheckBox(intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight, const char *bcaption);
  TGUI_CHECK_BOX  *AddGroupBox(intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight, const char *bcaption, int bgroup);

  TGUI_LABEL      *AddLabel(intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight);
  TGUI_LABEL      *AddLabel(intptr_t bkey, GLfloat bx, GLfloat by, const char *bcaption);
  TGUI_LABEL      *AddLabel(intptr_t bkey, GLfloat bx, GLfloat by, TGUI_TEXTURE *tex);

  TGUI_SLIDER     *AddSlider   (intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight, TGUI_SLIDER_TYPE btype);

  TGUI_SCROLL_BOX *AddScrollBox(intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight);
  TGUI_LIST_BOX   *AddListBox  (intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight);
  TGUI_EDIT_BOX   *AddEditBox  (intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight, unsigned max_lenght);
  TGUI_COMBO_BOX  *AddComboBox (intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight);
...
public:
  TGUI_SCROLL_BOX(TGUI_BOX *bowner, intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight)
...
public:
  TGUI_LIST_BOX(TGUI_BOX *bowner, intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight)
  ...
  { 
    ...
    items = NULL;
    items = GUI_NEW TGUI_LIST(this, 0, 0, 0, "");
...
public:
  TGUI_COMBO_BOX(TGUI_BOX *bowner, intptr_t bkey, GLfloat bx, GLfloat by, GLfloat bwidth, GLfloat bheight);
