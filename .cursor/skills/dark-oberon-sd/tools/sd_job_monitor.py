#!/usr/bin/env python3
"""
Monitor and manage Stable Diffusion board batch jobs.

Usage:
  python3 sd_job_monitor.py <boards-dir>           # Show status
  python3 sd_job_monitor.py <boards-dir> --watch    # Live polling
  python3 sd_job_monitor.py <boards-dir> --reset    # Clear state for re-run
  python3 sd_job_monitor.py <boards-dir> --preview  # Open last edited board
"""
